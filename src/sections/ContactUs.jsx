    ...
    <section id="contact" className="relative pb-20 md:pb-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#FF6600] mb-6">
         ...
         transition-all duration-300"
              >
                <div className="flex items-start space-x-4">
                  <div
                    className={`w-14 h-14 bg-[#ff8331] rounded-xl flex items-center justify-center flex-shrink-0 `}
                  >
         ...
         transition-all duration-300"
              >
                <div className="space-y-6">
                  ...
                  {(() => {
                    const baseInput =
                      "w-full px-4 py-3 bg-gray-400/60 rounded-xl text-slate-900 placeholder-white focus:outline-none transition-all duration-300";
                    ...
                    return (
                      <>
                        ...
                        <button
                          ...
                          disabled={loading}
                          className={`group w-full px-8 py-4 bg-[#ff8331] text-white rounded-xl font-bold flex items-center justify-center space-x-2 transition-all ${
