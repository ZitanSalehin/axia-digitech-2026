...
const HeroSection = () => {
  return (
    <section className="relative overflow-hidden bg-amber-900 text-white flex flex-col items-center w-full">
      <div className="relative mx-auto px-6 py-28">
        <div className="w-full flex flex-col items-center">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            <Link
              to="/services"
              className="inline-flex items-center gap-2 px-8 py-3 rounded-full border border-[#ff6600]/30 hover:bg-white/10 transition"
            >
              Our Services
            </Link>
          </div>
