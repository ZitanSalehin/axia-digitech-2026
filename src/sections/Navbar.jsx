...
export default function Navbar() {
  ...
  return (
    <nav
      ...
      style={{ marginTop: scrolled ? "0rem" : "3.6rem" }} // mt-2 → 0.5rem, mt-12 → 3rem
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-900 rounded-3xl">
